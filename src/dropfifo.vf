...
// /___/   /\     Timestamp : 01/30/2026 23:32:41
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w Z:/EE533/lab3_sp26/src/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   reg9B XLXI_15 (.ce(XLXN_12), 
                  ...
                  .d(in_fifo[71:0]), 
                  .q(in_fifo0[71:0]));
   dual_port_mem XLXI_16 (.addra(waddr[7:0]), 
                          .addrb(raddr[7:0]), 
                          .clka(clk), 
                          .clkb(clk), 
                          .dina(in_fifo0[71:0]), 
